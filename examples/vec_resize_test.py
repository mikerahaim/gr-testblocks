...
# Title: Test the vector resize block
# Author: Michael Rahaim
# Generated: Thu Jul  7 22:04:59 2016
##################################################
...
class vec_resize_test(gr.top_block, Qt.QWidget):
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_time_sink_x_0_0.set_samp_rate(self.samp_rate*self.out_len/self.in_len)
    ...
    def set_in_len(self, in_len):
        self.in_len = in_len
        self.blocks_vector_source_x_0.set_data(range(0,self.in_len), [])
        self.qtgui_time_sink_x_0.set_y_axis(0, self.in_len-1)
        self.qtgui_time_sink_x_0_0.set_y_axis(0, self.in_len-1)
        self.qtgui_time_sink_x_0_0.set_samp_rate(self.samp_rate*self.out_len/self.in_len)


def main(top_block_cls=vec_resize_test, options=None):
